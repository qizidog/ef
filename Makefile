...
prog_poll: main.c poll.c framework.c coroutine.c fiber.c /tmp/fiber.s
	gcc -g -O0 -m64 -std=gnu99 -o prog_poll main.c poll.c framework.c coroutine.c fiber.c /tmp/fiber.s

prog_kqueue: main.c kqueue.c framework.c coroutine.c fiber.c /tmp/fiber.s
	gcc -g -O0 -m64 -std=gnu99 -o prog_kqueue main.c kqueue.c framework.c coroutine.c fiber.c /tmp/fiber.s

prog_epoll: main.c epoll.c framework.c coroutine.c fiber.c /tmp/fiber.s
	gcc -g -O0 -m64 -std=gnu99 -o prog_epoll main.c epoll.c framework.c coroutine.c fiber.c /tmp/fiber.s

prog_epollet: main.c epollet.c framework.c coroutine.c fiber.c /tmp/fiber.s
	gcc -g -O0 -m64 -std=gnu99 -o prog_epollet main.c epollet.c framework.c coroutine.c fiber.c /tmp/fiber.s

prog_port: main.c port.c framework.c coroutine.c fiber.c /tmp/fiber.s
	gcc -g -O0 -m64 -std=gnu99 -o prog_port main.c port.c framework.c coroutine.c fiber.c /tmp/fiber.s
